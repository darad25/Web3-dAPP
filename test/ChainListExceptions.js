...
contract("ChainList", function(accounts){
  ...
  var articleDescription = "Description for article";
  var articlePrice = 10;
  ...
  it("should throw an exception if you try to buy an article when there is no article for sale yet", function() {
    ...
    .catch(function(error){
      ...
      assert.equal(data[3], "", "article description must be zero");
  ...
  // incorrect value
  it("should throw an exception if you try to buy your own article for value different from its price", function(){
    return ChainList.deployed().then(function(instance){
      chainListInstance = instance;
